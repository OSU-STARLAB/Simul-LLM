...
TRAIN_INPUT_PAIRS = [
    ('/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/train/txt/train-01.en', '/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/train/txt/train-01.de')
]

TEST_INPUT_PAIRS = [
    ('/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/tst-COMMON/txt/tst-COMMON-01.en', '/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/tst-COMMON/txt/tst-COMMON-01.de'),
    ('/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/tst-HE/txt/tst-HE-01.en', '/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/tst-HE/txt/tst-HE-01.de')
]

VALIDATION_INPUT_PAIRS = [
    ('/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/dev/txt/dev-01.en', '/nfs/hpc/share/wildma/dataset_prep/datasets/must-c-downloads/en-de/data/dev/txt/dev-01.de')
]

OUTPUT_JSON_TRAIN = '/nfs/hpc/share/wildma/dataset_prep/datasets/2023-fall/en-de/must-c-en-de-01-train.json'
OUTPUT_JSON_TEST = '/nfs/hpc/share/wildma/dataset_prep/datasets/2023-fall/en-de/must-c-en-de-01-test.json'
OUTPUT_JSON_VALIDATION = '/nfs/hpc/share/wildma/dataset_prep/datasets/2023-fall/en-de/must-c-en-de-01-validation.json'
...
def main():
    ...
    for train_pair in TRAIN_INPUT_PAIRS:
        ...
        while train_en_line != '' and train_es_line != '':
            ...
            output_file_train.write(f'{{"en": "{train_en_line}", "de": "{train_es_line}"}}\n')
    ...
    for test_pair in TEST_INPUT_PAIRS:
        ...
        while test_en_line != '' and test_es_line != '':
            ...
            output_file_test.write(f'{{"en": "{test_en_line}", "de": "{test_es_line}"}}\n')
    ...
    for validation_pair in VALIDATION_INPUT_PAIRS:
        ...
        while validation_en_line != '' and validation_es_line != '':
            ...
            output_file_validation.write(f'{{"en": "{validation_en_line}", "de": "{validation_es_line}"}}\n')
